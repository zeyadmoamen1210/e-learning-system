<template>
  <div>
          ...
          <tr v-for="x in 15" :key="x">
            ...
            <td>
              <div class="d-flex gap-5">
                <Button
                  @click.native="$router.push(`/dashboard/exam-correction/1`)"
                  padding="0"
                  type="text-primary"
                  text="تفاصيل الأسئلة">
    ...
    <ExamCorrectionFilter :isOpened="examCorrectionFilterPopup" @close="examCorrectionFilterPopup = false" />
  </div>
</template>
